...
'2021-2022')
st.markdown('''
- Developed model using <span style='color:#000000;font-weight:bold'>unsupervised K-means clustering</span> and <span style='color:#000000'>fbprophet</span> to forecast machine maintenance using peak detection and <span style='color:#000000'>Time-series Data</span>. Achieved <span style='color:#000000'>97%</span> accuracy
