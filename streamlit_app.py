...
# st.info('''
# &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;**HAVE YOU TRIED TURNING IT OFF AND ON AGAIN?**
# \nI am a highly accomplished data scientist with a strong focus on achieving measurable results. I possess extensive experience working within cross-functional teams to achieve organizational objectives. Being highly motivated to innovate existing business processes, I achieve optimal results in an efficient and cost-effective manner, utilizing my in-depth domain expertise. I have consistently demonstrated exceptional diligence and commitment to excellence in both my coursework and various work. I am eager to continue this level of performance in future projects, utilizing diverse models, frameworks, and data.
# ''')
...
with cols[3]:
  # st.write(Email)
  st.markdown(f"<a href='mailto:{Email}'>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Email</a>", unsafe_allow_html=True)
...
st.markdown("""---""")
st.info('''
&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;**HAVE YOU TRIED TURNING IT OFF AND ON AGAIN?**
\nI am a highly accomplished data scientist with a strong focus on achieving measurable results. I possess extensive experience working within cross-functional teams to achieve organizational objectives. Being highly motivated to innovate existing business processes, I achieve optimal results in an efficient and cost-effective manner, utilizing my in-depth domain expertise. I have consistently demonstrated exceptional diligence and commitment to excellence in both my coursework and various work. I am eager to continue this level of performance in future projects, utilizing diverse models, frameworks, and data.
''')
...
txt("**<span style='color:#000000'>Lead Data Scientist</span>**, *<span style='color:#000000'>Urja.io</span>*, India", '2021-2022')
st.markdown('''
- Spearheaded the development team in creating an analytics dashboard platform, resulting in a <span style='color:#16A2CB;font-weight:bold'>25%</span> increase in client engagement
- Achieved a <span style='color:#16A2CB;font-weight:bold'>23%</span> cost reduction by delivering a <span style='color:#16A2CB;font-weight:bold'>94%</span> accurate machinery failure prediction using fbprophet time series forecasting
- Built a customer churn model with a <span style='color:#16A2CB;font-weight:bold'>70%</span> recall and prescriptive reports on Tableau to retain IoT business
- Implemented a scalable distributed ETL/ELT pipeline infrastructure, enabling real-time time-series data collection and anomaly detection from structured or unstructured data generated by <span style='color:#16A2CB;font-weight:bold'>2,000</span> IoT devices with minimal data loss
- Saved <span style='color:#16A2CB;font-weight:bold'>10</span> person-hours biweekly by efficiently communicating A/B test results to stakeholders via concise, automated reports
''', unsafe_allow_html=True)

txt("**<span style='color:#000000'>Software Engineer</span>**, *<span style='color:#000000'>Société Générale</span>*, India", '2017-2020')
st.markdown('''
- Realized a <span style='color:#16A2CB;font-weight:bold'>20%</span> cost reduction and accelerated module implementation by <span style='color:#16A2CB;font-weight:bold'>30%</span> through streamlined REST API development and global Infrastructure as Code deployment using Terraform, Packer AMI, and Gitlab CI/CD
- Enhanced fraud detection by <span style='color:#16A2CB;font-weight:bold'>17%</span> by applying predictive modeling techniques to detect irregular transaction volume changes
- Improved risk management by <span style='color:#16A2CB;font-weight:bold'>21%</span> via identification of high-value transactions exceeding model forecasts
''', unsafe_allow_html=True)
...
txt("**<span style='color:#000000'>[ImagiGEN](https://github.com/orgs/ImagiGEN/repositories)</span>**, *<span style='color:#000000'>Northeastern University</span>*, Boston, MA", 'May 2023 - Aug 2023')
st.markdown('''
- Developed an emotion-aware audio journaling app with voice tone analysis for precise emotional detection. Integrated mood chart visualization and prompt engineering to achieve a <span style='color:#16A2CB;font-weight:bold'>20%</span> increase in user retention
- Led cross-functional teams in creating a contextual search tool for financial researchers, introducing vector similarity, traditional filters, and hybrid search approaches to enhance information retrieval speed by <span style='color:#16A2CB;font-weight:bold'>50%</span> with greater context for improved insights
